...
class TimeoutFailure extends Failure {
  const TimeoutFailure({this.message = 'Request timed out'}) : super._();
...
class NoInternetFailure extends Failure {
  const NoInternetFailure({this.message = 'No internet connection'})
      : super._();
...
/// @nodoc
abstract mixin class $NoInternetFailureCopyWith<$Res>
    implements $FailureCopyWith<$Res> {
  factory $NoInternetFailureCopyWith(
          NoInternetFailure value, $Res Function(NoInternetFailure) _then) =
...
class UnknownFailure extends Failure {
  const UnknownFailure({this.message = 'Unknown error'}) : super._();
