...
extension FeedStatePatterns on FeedState {
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case _Loading() when loading != null:
        return loading();
      case _Loaded() when loaded != null:
        return loaded(_that.products, _that.currentPage, _that.hasMore);
      case _Error() when error != null:
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(
            List<Product> products, int currentPage, bool hasMore)
        loaded,
...
class _Loaded implements FeedState {
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(_products), currentPage, hasMore);

  @override
  String toString() {
    return 'FeedState.loaded(products: $products, currentPage: $currentPage, hasMore: $hasMore)';
  }
}
